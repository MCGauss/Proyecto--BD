...
public class SeleccionQuinielaFrame extends JFrame {
    ...
    private void iniciarComponentes() {
        ...
        lblTitulo = new JLabel("SELECCIONA TU TIPO DE QUINIELA");
        ...
        cardJornada.setBackground(new Color(15,23,42));
        cardJornada.setBounds(120, 160, 400, 330);
        cardJornada.setBorder(BorderFactory.createLineBorder(new Color(59,130,246),3));
       
        JLabel lblJornadaTitulo = new JLabel("POR JORNADA",SwingConstants.CENTER);
        lblJornadaTitulo.setForeground(Color.WHITE);
        lblJornadaTitulo.setFont(new Font("Segoe UI", Font.BOLD, 28));
        lblJornadaTitulo.setBounds(0, 30, 400, 40);
        ...
        lblJornadaDesc.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        lblJornadaDesc.setBounds(40, 85, 320, 150);

        btnJornada = new JButton("ENTRAR");
        btnJornada.setBounds(110, 255, 180, 45);
        ...
        btnJornada.setBackground(new Color(59,130,246));
        btnJornada.setForeground(Color.WHITE);
        btnJornada.setFont(new Font("Segoe UI", Font.BOLD, 16));
        btnJornada.setFocusPainted(false);
        btnJornada.setBorderPainted(false);
        btnJornada.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        cardTorneo.setBackground(new Color(15,23,42));
        cardTorneo.setBounds(650, 160, 400, 330);
        cardTorneo.setBorder(BorderFactory.createLineBorder(new Color(16,185,129),3));

        JLabel lblTorneoTitulo = new JLabel("TORNEO COMPLETO",SwingConstants.CENTER);
        lblTorneoTitulo.setForeground(Color.WHITE);
        lblTorneoTitulo.setFont(new Font("Segoe UI", Font.BOLD, 26));
        lblTorneoTitulo.setBounds(0, 30, 400, 40);
        ...
        lblTorneoDesc.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        lblTorneoDesc.setBounds(40, 85, 320, 150);

        btnTorneo = new JButton("ENTRAR");
        btnTorneo.setBounds(110, 255, 180, 45);
        ...
        btnTorneo.setBackground(new Color(16,185,129));
        btnTorneo.setForeground(Color.WHITE);
        btnTorneo.setFont(new Font("Segoe UI", Font.BOLD, 16));
        btnTorneo.setFocusPainted(false);
        btnTorneo.setBorderPainted(false);
        btnTorneo.setCursor(new Cursor(Cursor.HAND_CURSOR));
